...
{ 
  ...
  public  static final boolean tracing = false;      //  Enable ENTER/EXIT.
...
//  Map token numbers to strings.
  ...
  public static final String[] tokenString =
  { "min token",        //  minToken
    "and",              //  boldAndToken
...
//  EXIT. Like EXIT, but the message says METHOD has finished.
